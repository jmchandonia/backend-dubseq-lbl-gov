			...
			<Carousel.Item interval={2500} >
				<div className='carousel-content'>
					<div style={{ maxWidth: '400px' }}>
						...
						<Link to='/graphPage' type="button" style={{ backgroundColor: "#fa7f72", color: "#ffffff" }} className="btn">More</Link>
					</div>
					<img
			...
			<Carousel.Item interval={2500}>
				<div className='carousel-content'>
					<div style={{ maxWidth: '500px' }}>
						...
						<Link to='/organisms/1' type="button" style={{ backgroundColor: "#fa7f72", color: "#ffffff" }} className="btn">More</Link>
					</div>
					<img
						style={{ height: '75%', width: "auto" }}
